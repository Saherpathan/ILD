...
data = pd.read_csv("../../datasets/Diff_genes_heatmap_NSIP-IPF.csv")

# Filter columns starting with "NSIP" and "HEALTHY"
columns_to_use = [col for col in data.columns if col.startswith("NSIP") or col.startswith("IPF")]
...
plt.savefig('NI_curve.png')  # Save the plot as an image
