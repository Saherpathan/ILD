...
data = pd.read_csv("../../datasets/Diff_genes_heatmap_IPF-CHP.csv")

# Filter columns starting with "NSIP" and "HEALTHY"
columns_to_use = [col for col in data.columns if col.startswith("IPF") or col.startswith("CHP")]
...
plt.savefig('IC_curve.png')  # Save the plot as an image
